...
impl Matrix {
    ...
    pub fn get_two_mut_same_row(&mut self, row: usize, col1: usize, col2: usize) 
    ...
    pub fn get_two_mut_different_rows(&mut self, a: (usize, usize), b: (usize, usize)) 
        -> Option<(&mut i32, &mut i32)> 
    {
        if a.0 == b.0 {
    ...
    pub fn get_two_mut_general(&mut self, a: (usize, usize), b: (usize, usize)) 
        -> Option<(&mut i32, &mut i32)> 
    {
...
mod tests {
    ...
    fn test_layered_matrix_get_two_mut_different_layers() {
        ...
        if let Some((a, b)) = lm.get_two_mut_different_layers(
            (Layer::Input, 0), 
            (Layer::Output, 1)
        ) {
            *a = 100;
    ...
    fn test_layered_matrix_get_two_mut_general() {
        ...
        // Different layers
        if let Some((a, b)) = lm.get_two_mut_general(
            (Layer::Input, 0), 
            (Layer::Hidden, 1)
        ) {
            *a = 11;
